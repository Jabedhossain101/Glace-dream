                              ...
                              {cart.map((product) => (
                                <li key={product.cartItemId} className="flex py-6">
                                  <div className="h-24 w-24 flex-shrink-0 overflow-hidden rounded-md border border-gray-200">
                                    <img
                                      src={product.activeImage || product.image}
                                      alt={product.name}
                                  ...
                                  <div className="ml-4 flex flex-1 flex-col">
                                    <div>
                                      ...
                                      <p className="mt-1 text-sm text-gray-500">{product.selectedColor} {product.selectedSize ? `| ${product.selectedSize}` : ''}</p>
                                    </div>
                                    <div className="flex flex-1 items-end justify-between text-sm">
                                      <div className="flex items-center border border-gray-300 rounded-md">
                                        ...
                                        <span className="px-2 font-medium text-gray-900">{product.quantity}</span>
                                        <button 
                                            onClick={() => updateQuantity(product.cartItemId, product.quantity + 1)}
